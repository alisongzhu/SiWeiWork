...
#else
void setPortState(STP_BRIDGE* bridge, int givenPort, int givenTree, unsigned int state, unsigned int timestamp)
{
	assert (givenPort != -1);
	assert (givenTree != -1);
	...
	bridge->callbacks.setPortState(bridge,givenPort,givenTree,state,timestamp);
}
#endif
// ============================================================================
// 13.27.h - 13.27.8
