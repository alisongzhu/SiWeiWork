...
static inline void sys_ring_buf_init(struct ring_buf *buf,
...
static inline int sys_ring_buf_put(struct ring_buf *buf,
...
static inline int sys_ring_buf_get(struct ring_buf *buf,
						u16_t *type, u8_t *value,
						u32_t *data, u8_t *size32)
{
