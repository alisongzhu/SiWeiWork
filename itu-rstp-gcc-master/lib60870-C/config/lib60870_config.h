 ...
 */
#define CONFIG_SLAVE_USE_SEPARATE_CALLBACK_THREAD 1

/**
 * Queue to store received ASDUs before passing them to the user provided callback.
 */
#define CONFIG_SLAVE_SEPARATE_CALLBACK_THREAD_QUEUE_SIZE  32
 ...
 */
#define CONFIG_SLAVE_ASDU_QUEUE_SIZE 32
 ...
 * For each queued message about 256 bytes of memory are required.
 */
#define CONFIG_SLAVE_CONNECTION_ASDU_QUEUE_SIZE 32
